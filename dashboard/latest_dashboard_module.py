...
if __name__ == "__main__":
    ...
    mock_customers = [
        ...
        {"customer_id": "c3", "name": "Charlie", "phone": "919876543212", "tag": None,               "total_orders": 1, "total_spent_cents": 50000},
        {"customer_id": "c4", "name": "Dave",    "phone": "919876543213", "tag": "inactive_customer","total_orders": 0, "total_spent_cents": 0},
        {"customer_id": "c5", "name": "Eve",     "phone": "919876543214", "tag": "repeat_customer",  "total_orders": 2, "total_spent_cents": 80000},
    ]
    mock_payments = [
        {"payment_id": "p101", "customer_id": "c1", "amount_cents": 50000, "status": "paid"},
        {"payment_id": "p102", "customer_id": "c1", "amount_cents": 20000, "status": "unpaid"},
        {"payment_id": "p103", "customer_id": "c3", "amount_cents": 10000, "status": "paid"},
        {"payment_id": "p104", "customer_id": "c4", "amount_cents": 30000, "status": "unpaid"},
    ]
